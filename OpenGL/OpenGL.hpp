...
std::array<bool, 255> keysPressed = {false};
std::array<bool, 255> specialKeysPressed = {false};

ButtonPressed mouseButtonPressed = ButtonPressed::NONE;
int mouseX = 0;
int mouseY = 0;
...
namespace arcade
{
    ...
    class Window : public GraphicalWindow {
         ...
         * @param shiftX width of pixel
         * @param shiftY height of pixel
         */
        void displayDefaultPixel(const std::pair<int, int> &coords, const arcade::Pixel &pixel, float shiftX, float shiftY);
